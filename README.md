...
<body>
  ...
  <main class="grid">
    ...
    <div class="card">
      <img src="{% static 'img1.png' %}" alt="Design shot">
      <div class="info">
    ...
    <div class="card">
      <img src="{% static 'img2.png' %}" alt="Design shot">
      <div class="info">
    ...
    <div class="card">
      <img src="{% static 'img3.png' %}" alt="Design shot">
      <div class="info">
    ...
    <div class="card">
      <img src="{% static 'img4.png' %}" alt="Design shot">
      <div class="info">
    ...
    <div class="card">
      <img src="{% static 'img5.png' %}" alt="Design shot">
      <div class="info">
    ...
    <div class="card">
      <img src="{% static 'img6.png' %}" alt="Design shot">
      <div class="info">
    ...
    <div class="card">
      <img src="{% static 'img7.png' %}" alt="Design shot">
      <div class="info">
    ...
    <div class="card">
      <img src="{% static 'img8.png' %}" alt="Design shot">
      <div class="info">
    ...
    <div class="card">
      <img src="{% static 'img9.png' %}" alt="Design shot">
      <div class="info">
    ...
    <div class="card">
      <img src="{% static 'img10.png' %}" alt="Design shot">
      <div class="info">
    ...
    <div class="card">
      <img src="{% static 'img11.png' %}" alt="Design shot">
      <div class="info">
    ...
    <div class="card">
      <img src="{% static 'img12  .png' %}" alt="Design shot">
      <div class="info">
...
## OUTPUT:
<img width="1244" height="627" alt="image" src="https://github.com/user-attachments/assets/dff8afc0-39c8-4b32-8de1-c6116d545e16" />
